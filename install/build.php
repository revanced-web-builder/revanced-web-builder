...
$allowedApps = array('YouTube', 'YouTube Music', 'Crunchyroll', 'Citra Emulator', 'Reddit', 'Spotify', 'TikTok', 'Twitch', 'Twitter', 'Pflotsh', 'WarnWetter', 'HexEditor', 'IconPackStudio', 'My Expenses', 'Nyx Music');
...
$appNameShortcuts = array("YouTube"=>"yt", "YouTube Music"=>"ym", "Citra Emulator"=>"ci", "Crunchyroll"=>"cr", "Reddit"=>"re", "Spotify" => "sp", "TikTok"=>"tt", "Twitch"=>"tc", "Twitter"=>"tw", "IconPackStudio"=>"ip", "Pflotsh"=>"pf", "WarnWetter"=>"ww", "HexEditor"=>"he", "My Expenses"=>"my", "Nyx Music"=>"nx");
